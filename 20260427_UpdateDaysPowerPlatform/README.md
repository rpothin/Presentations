...
- **📑 Slide Deck:** [Mitigating AI risks from injection, exfiltration and unsafe actions
](./Mitigating AI risks from injection, exfiltration and unsafe actions.pdf)
...
### 🎨 Presentation Materials
- **📑 Slide Deck:** [Finding security threats and limiting their impact](./Finding security threats and limiting their impact.pdf)
...
### 🎨 Presentation Materials
- **📑 Slide Deck:** [Deploying Power Platform and Azure infrastructure as code](./Deploying Power Platform and Azure infrastructure as code.pdf)
